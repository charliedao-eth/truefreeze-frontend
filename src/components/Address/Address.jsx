...
function Address(props) {
  ...
  useEffect(() => {
    setAddress(props?.address || (isWeb3Enabled && account));
  }, [account, isWeb3Enabled, props]);
...
const Check = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" strokeWidth="3" stroke="#21BF96" fill="none" strokeLinecap="round" strokeLinejoin="round">
    <path stroke="none" d="M0 0h24v24H0z" fill="none" />
